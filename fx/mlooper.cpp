    ...
    if(mlooper_play)
    {
        if(!mlooper_frozen) // if the looper is not frozen
        {
            ...
            if(mlooper_play)
            {
                ...
                out1l = GetSampleFromBuffer(IMultiVersioCommon::mlooper_buf_1l,
                                            mlooper_pos_1)
                        * mlooper_volume_att_1;
                out1r = GetSampleFromBuffer(IMultiVersioCommon::mlooper_buf_1r,
                                            mlooper_pos_2)
        ...
        { // if the buffer is not frozen we get one sample from the frozen looper
            ...
            if(mlooper_play)
            {
                ...
                out1l = GetSampleFromBuffer(this->mv.mlooper_frozen_buf_1l,
                                            mlooper_frozen_pos_1)
                        * mlooper_volume_att_1;
                out1r = GetSampleFromBuffer(this->mv.mlooper_frozen_buf_1r,
                                            mlooper_frozen_pos_2)
                        * mlooper_volume_att_2;
            }
        };
